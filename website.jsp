...
.feature p {
    ...
    @media (max-width: 992px) {
        ...
        .appointment-section {
          position: relative;
          background: url('images/ab2.png') no-repeat center center/cover;
          height: 400px;
          display: flex;
          justify-content: center;
          align-items: center;
...
<body>
    ...
    <div class="main-section">
        ...
        <div class="icons-section">
             <div class="icons-section">
             <div class="icon-box" onclick="redirectToPage1();">
...
<script>
    function redirectToPage1() {
        var userRole = "<%= session.getAttribute("role") %>"; // Fetch role from session
        if (userRole === "Doctor") {
            window.location.href = 'appointment.jsp';
        } else if (userRole === "Patient") {
            window.location.href = 'bookappointment.jsp';
        } else {
            alert("Please log in to continue.");
            window.location.href = 'login1.jsp'; // Redirect to login if session is not set
        }
    }
</script>
             <div class="icon-box" onclick="window.location.href='medical_record.jsp';">
                <img src="images/medicine.jpg" alt="Medicine" width="150">
                <p>Medi Archives</p>
            </div>
            <div class="icon-box" onclick="redirectToPage();">
                <img src="images/doctor.jpg" alt="Talk to the Doctor" width="140">
                <p>Face Time</p>
            </div>
           <script>
    function redirectToPage() {
        var userRole = "<%= session.getAttribute("role") %>"; // Fetch role from session
        if (userRole === "Doctor") {
            window.location.href = 'videocall2.jsp';
        } else if (userRole === "Patient") {
            window.location.href = 'videocall21.jsp';
        } else {
            alert("Please log in to continue.");
            window.location.href = 'login1.jsp'; // Redirect to login if session is not set
        }
            ...
            <div class="icon-box" onclick="window.location.href='healthtrend.html';">
                <img src="images/ag.jpg" alt="Health Trends" width="170">
                <p>Article</p>
            </div>
        </div>
    </div>
  ...
  <section class="appointment-section">
    <div class="appointment-popup">
        ...
        <p>Click here to check your appointment with a doctor.</p>
    ...
    <button onclick="window.location.href='contact.html'" id="consultButton">
        CONSULT US
    </button>
</section>
...
<section id="imageGallery">
   ...
   <div id="chatbot" style="position: fixed; bottom: 20px; right: 20px; z-index: 10000;">
    <script src='https://cdn.jotfor.ms/s/umd/latest/for-embedded-agent.js'></script>
    <script>
        window.addEventListener("DOMContentLoaded", function() {
            window.AgentInitializer.init({
                agentRenderURL: "https://agent.jotform.com/0194fa6747007228b1361f690e89688c796a",
                rootId: "JotformAgent-0194fa6747007228b1361f690e89688c796a",
                formID: "0194fa6747007228b1361f690e89688c796a",
                queryParams: ["skipWelcome=1", "maximizable=1"],
                domain: "https://www.jotform.com",
                isDraggable: false,
                background: "linear-gradient(180deg, #83D0E4 0%, #83D0E4 100%)",
                buttonBackgroundColor: "#264B67",
                buttonIconColor: "#FFF",
                variant: false,
                customizations: {
                    "greeting": "Yes",
                    "greetingMessage": "Hii! How can I help you?",
                    "pulse": "Yes",
                    "position": "right",
                    "autoOpenChatIn": "5000"
                },
